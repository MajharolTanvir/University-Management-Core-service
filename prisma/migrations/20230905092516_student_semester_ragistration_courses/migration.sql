...
CREATE TABLE "student_semester_registration_course" (
    ...
    CONSTRAINT "student_semester_registration_course_pkey" PRIMARY KEY ("studentId","offeredCourseId","semesterRegistrationId")
);
...
-- AddForeignKey
ALTER TABLE "student_semester_registration_course" ADD CONSTRAINT "student_semester_registration_course_offeredCourseSectionI_fkey" FOREIGN KEY ("offeredCourseSectionId") REFERENCES "offered_course_selection"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

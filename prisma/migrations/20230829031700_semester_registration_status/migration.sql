...
ALTER TABLE "semester_registration" ALTER COLUMN "status" DROP DEFAULT;
ALTER TABLE "semester_registration" ALTER COLUMN "status" TYPE "SemesterRegistrationStatus_new" USING ("status"::text::"SemesterRegistrationStatus_new");
...
ALTER TABLE "semester_registration" ALTER COLUMN "status" SET DEFAULT 'UPCOMING';
COMMIT;
